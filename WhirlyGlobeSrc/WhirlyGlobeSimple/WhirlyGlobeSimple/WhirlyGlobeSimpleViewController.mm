...
- (void)viewDidLoad
{
	...
	self.layerThread = [[[WhirlyKitLayerThread alloc] initWithScene:theScene view:self.theView renderer:sceneRenderer] autorelease];
...
- (void)addParticleSystems:(id)what
{
    ...
    WhirlyKit::GeoCoord washDc = WhirlyKit::GeoCoord::CoordFromDegrees(-77.036667,38.895111);
...
- (void)addMarkers:(id)what
{
    ...
    WhirlyKit::GeoCoord paris = WhirlyKit::GeoCoord::CoordFromDegrees(2.350833, 48.856667);
